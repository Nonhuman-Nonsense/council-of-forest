...
describe('Summary Overlay', () => {
    ...
    it('renders summary content correctly', () => {
        ...
        const councilEls = screen.getAllByText('COUNCIL OF FOREST');
        ...
        expect(
            screen.getAllByText(/This document was created by the Council of Forest/).length,
        ).toBeGreaterThan(0);
        expect(
            screen.getAllByRole('link', { name: 'Nonhuman Nonsense' }).length,
        ).toBeGreaterThan(0);
        expect(
            screen.getAllByRole('link', { name: /Vinnova \(ref\. nr\. 2025-00344\)/ }).length,
        ).toBeGreaterThan(0);
    ...
    it('renders correctly in mobile mode', () => {
        ...
        expect(screen.getAllByText('COUNCIL OF FOREST').length).toBeGreaterThan(0);
    });
