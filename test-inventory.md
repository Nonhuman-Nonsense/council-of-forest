...
**Totals:** 167 test files, ~1301 cases
(client 111 files / 860 cases, server 56 files / 441 cases).
...
|---|---|---|---|---|---|
| client/tests/unit/hooks/useCouncilMachine.test.tsx | 53 (+4 each) | 1774 |  | 2.8 | 46 |
| client/tests/unit/components/HumanInput.render.test.tsx | 45 | 1196 |  | 1.8 | 4 |
...
| server/tests/AudioUtils.test.ts | 16 | 191 |  | 1.3 | 7 |
...
| client/tests/unit/setupAgent/MeetingSetupAgent.ptt.test.tsx | 7 | 183 |  | 1.4 | 0 |
...
| client/tests/unit/components/Council.test.tsx | 10 | 328 |  | 1.6 | 39 |
| client/tests/unit/museum/metaAgent/metaAgentPrompt.test.ts | 26 | 273 |  | 2.3 | 9 |
...
| client/tests/forest/Main.test.tsx | 5 | 244 |  | 1.6 | 2 |
| client/tests/unit/components/RouterLogic.test.tsx | 8 | 241 |  | 1.9 | 20 |
| client/tests/unit/council/summaryScrollSync.test.ts | 14 | 241 |  | 1.4 | 3 |
| client/tests/unit/components/MeetingSetupReset.test.tsx | 3 | 218 |  | 2.7 | 6 |
| client/tests/unit/components/settings/SelectFoods.test.tsx | 8 | 211 |  | 3.4 | 3 |
| client/tests/foods/Main.test.tsx | 4 | 207 |  | 1.5 | 2 |
| client/tests/unit/logger.test.ts | 12 | 204 |  | 1.8 | 8 |
| client/tests/unit/AutoButton.test.tsx | 7 | 203 |  | 2.4 | 1 |
| client/tests/forest/components/LanguageSwitch.test.tsx | 3 | 192 |  | 2.7 | 8 |
| client/tests/unit/setupAgent/MeetingSetupAgent.ptt.test.tsx | 7 | 183 |  | 1.4 | 0 |
| client/tests/unit/components/FoodAnimation.test.tsx | 6 | 179 |  | 2 | 9 |
| client/tests/unit/components/FoodItem.test.tsx | 7 | 178 |  | 1.9 | 4 |
| client/tests/unit/components/HumanInput.test.tsx | 15 | 175 |  | 1.9 | 11 |
...
| client/tests/unit/components/Main.test.tsx | 3 | 152 |  | 1.3 | 2 |
...
| client/tests/forest/components/Audio.test.tsx | 3 | 142 |  | 3 | 1 |
...
| client/tests/unit/realtime/RealtimeCaptionOverlay.test.tsx | 7 | 120 |  | 2 | 8 |
...
| client/tests/e2e/src/button_setup.spec.ts | 4 | 99 |  | 1 | 9 |
| client/tests/unit/main/overlay/errorStore.test.ts | 12 | 99 |  | 1.1 | 1 |
| client/tests/forest/components/Forest.test.tsx | 4 | 94 |  | 1.8 | 1 |
...
| client/tests/forest/content/Branding.test.tsx | 2 | 71 |  | 3 | 1 |
| client/tests/unit/council/participationPhase.test.ts | 11 | 70 |  | 1.2 | 1 |
...
| client/tests/unit/components/VideoPreloader.test.tsx | 2 | 52 |  | 5.5 | 4 |
...
| client/tests/unit/setupAgent/setupAgentPrompt.test.ts | 6 | 45 |  | 1.7 | 0 |
...
| server/tests/DialogGenerator.test.js | 25 | 513 |  | 2.1 | 10 |
| server/tests/meetingsHttpAndSocket.integration.test.js | 10 | 419 |  | 2.7 | 12 |
| server/tests/realtimeProviders.test.ts | 11 (+1 each) | 396 |  | 2.5 | 15 |
...
| server/tests/realtimeSessionApi.integration.test.ts | 12 | 327 |  | 2.7 | 6 |
...
| server/tests/SummaryGeneration.test.ts | 2 | 219 |  | 6 | 6 |
